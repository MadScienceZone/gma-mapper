...
#			 [ttk::menubutton $st.r.ft -menu $st.r.ftmenu -textvariable PEsFT] - - - -sticky w
		...
		if {$::tcl_platform(os) eq "Darwin"} {
			if $dark {
				ttk::style configure Sep.TLabel -foreground cyan
			} else {
				ttk::style configure Sep.TLabel -foreground blue
			}
			ttk::style configure GMSep.TLabel -foreground red
		} else {
			if $dark {
				ttk::style configure Sep.TLabel -foreground white -background #000090
			} else {
				ttk::style configure Sep.TLabel -foreground white -background black
			}
			ttk::style configure GMSep.TLabel -foreground white -background #883333
		}
		...
		grid [ttk::label $w.n.a.title -text "MAPPER APPEARANCE SETTINGS" -anchor center -style Sep.TLabel] - - - - - - -sticky we -pady 5
		...
		grid [ttk::label $w.n.a.title2 -text "EXTRA GRID LINES" -anchor center -style Sep.TLabel] - - - - - - -sticky we -pady 5
		...
		grid [ttk::label $w.n.t.title -text "PATHS TO SUPPORT PROGRAMS" -anchor center -style Sep.TLabel] - -sticky we -pady 5
		grid [ttk::label $w.n.t.curl_label -text "Curl program path:"] \
		     [ttk::entry $w.n.t.curl -textvariable curl_path] -sticky w

		grid [ttk::label $w.n.d.title -text "DIAGNOSTIC/DEBUGGING OPTIONS" -anchor center -style Sep.TLabel] - -sticky we -pady 5
		...
		frame $s
		grid [ttk::label $s.title -text "CONNECTION" -anchor center -style Sep.TLabel] - - \
		     [ttk::label $s.gmtitle -text "GM SETTINGS" -anchor center -style GMSep.TLabel] - \
			     -sticky we -pady 5
		...
		grid [ttk::label $s.title2 -text "GENERAL SETTINGS" -anchor center -style Sep.TLabel] - - \
